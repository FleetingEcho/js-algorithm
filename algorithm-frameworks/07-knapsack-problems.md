...
2. [0-1 背包模板](#-0-1-背包模板)
3. [完全背包模板](#-完全背包模板)
4. [问题一：分割等和子集（0-1 背包判断能否装满）](#-问题一分隔等和子集0-1-背包判断能否装满)
5. [状态压缩：从二维到一维](#-状态压缩从二维到一维)
6. [问题二：零钱兑换 II（完全背包组合数）](#-问题二零钱兑换-ii完全背包组合数)
7. [排列 vs 组合：遍历顺序的秘密](#-排列-vs-组合遍历顺序的秘密)
8. [复杂度速查表](#-复杂度速查表)
9. [刷题建议](#-刷题建议)
...
i
0       T  F  F  F  F  F  F  F  F  F  F  F  ← 没有数字
1 (1)   T  T  F  F  F  F  F  F  F  F  F  F
2 (5)   T  T  F  F  F  T  T  F  F  F  F  F
3 (11)  T  T  F  F  F  T  T  F  F  F  F  T  ← dp[3][11] = T ✅
