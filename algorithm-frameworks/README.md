...
> 基于 labuladong 算法框架思维的结构化总结 —— 将 40+ 个零散的笔记重构为 **33 篇结构化 Markdown**，覆盖 **269 道 LeetCode 高频题**。
>
...
flowchart LR
    ...
    subgraph 进阶 [Phase 4 进阶]
        E0["28 LRU缓存"] --> E1["29 Trie"]
        E2["30 二叉树进阶"]
        E3["32 位运算"] --> E4["34 OOD"]
        E5["35 贪心"]
    end
    
    基础 --> 搜索 --> DP --> 数据结构 --> 进阶 --> F["36 模式识别总结"]
...
flowchart TD
    ...
    S06 --> S07["14 双指针 / 15 滑动窗口"]
    S07 --> S08["20 nSum / 35 贪心"]
    S08 --> S09["18 链表 / 25 并查集"]
    S09 --> S10["26 图 / 28 LRU / 29 Trie"]
    S10 --> DONE["💪 持续刷题"]
    
    QUICK --> Q01["05 二分搜索"]
    Q01 --> Q02["06 DP框架"]
    Q02 --> Q03["14 双指针 / 15 滑动窗口"]
    Q03 --> Q04["02 DFS 回溯"]
    Q04 --> Q05["20 nSum"]
    Q05 --> Q06["07 背包 / 08 股票"]
    Q06 --> DONE
...
| 14 | [双指针技巧](14-two-pointers.md) | 快慢/左右/归并/三指针 四种模式、接雨水 | 18 |
| 15 | [滑动窗口](15-sliding-window.md) | 万能滑动窗口模板、最小覆盖子串、定长窗口 | 8 |
| 17 | [单调栈](17-monotonic-stack.md) | 下一个更大元素、每日温度、环形数组、接雨水 | 8 |
| 18 | [链表技巧](18-linked-list-techniques.md) | 反转链表、快慢指针、相交链表、回文链表、K 组反转 | 16 |
| 19 | [前缀和与差分数组](19-prefix-sum-and-diff-array.md) | 前缀和 + 二分、和为 K 的子数组、差分航班预订 | 8 |
| 20 | [nSum 问题](20-n-sum-problems.md) | 两数之和→三数→四数、递归 nSum 统一框架 | 8 |
| 21 | [回文串与字符串](21-palindrome-and-string-techniques.md) | 中心扩展、验证回文串、最长回文子串 | 11 |
| 22 | [哈希表技巧](22-hash-table-techniques.md) | 两数之和、字母异位词分组、最长连续序列 | 10 |
| 23 | [堆与优先级队列](23-heap-and-priority-queue.md) | 双堆求中位数、Top K、合并 K 个链表 | 7 |
| 24 | [区间与扫描线](24-interval-and-sweep-line.md) | 合并区间、会议室 II、扫描线模板 | 7 |
| 25 | [并查集 Union-Find](25-union-find.md) | 路径压缩 + 按秩合并、岛屿数量、账户合并 | 7 |
| 26 | [图算法](26-graph-algorithms.md) | Dijkstra、拓扑排序、二分图染色 | 9 |

### 🔷 Phase 4 — 进阶专题 (7 篇)

| # | 文件 | 一句话总结 | 核心题数 |
|---|------|-----------|:-------:|
| 28 | [LRU & LFU 缓存](28-lru-and-lfu-cache.md) | 哈希表 + 双向链表、频率桶淘汰 | 2 |
| 29 | [Trie 前缀树](29-trie-prefix-tree.md) | 插入/搜索/前缀搜索模板、通配符匹配 | 4 |
| 30 | [二叉树进阶](30-binary-tree-advanced.md) | LCA、序列化、路径综合、BST 迭代器 | 10 |
| 32 | [位运算](32-bit-manipulation-and-math.md) | 异或性质、n&(n-1)、位掩码枚举子集 | 6 |
| 34 | [设计与 OOD](34-design-and-ood.md) | 最小栈、O(1)随机访问、LFU、文件系统 | 12 |
| 35 | [贪心算法](35-greedy.md) | 区间调度、跳跃游戏、加油站 | 7 |
| 36 | [算法模式识别总结](36-algorithm-pattern-recognition.md) | 看到什么→想到什么速查表 + 面试策略 | — |
...
```
新手友好路径：
  00 → 01 → 12 → 13 → 02 → 03 → 04 → 05 → 06 → 07 → 14 → 15 → 20 → 36

面试速刷路径：
  36 → 05 → 06 → 02 → 14 → 15 → 20 → 07 → 08 → 18 → 22 → 23 → 35
```
